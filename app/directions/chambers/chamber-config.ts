...
> = {
  ...
  'wall-lightning': {
    ...
    description:
      'Two luminous rails define the safe passage across seamless black glass. Beyond them, silent survey skimmers patrol almost-black water while irregular storms frame a distant triple helix.'
  },
  terminal: {
    index: 'F3',
    code: 'GHOST_TERMINAL',
