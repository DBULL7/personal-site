...
> = {
  ...
  'wall-lightning': {
    ...
    description:
      'Two luminous rails define the safe passage across seamless black glass. Beyond them, irregular storms frame a distant triple helix climbing into the dark.'
  },
  terminal: {
    index: 'F3',
    code: 'GHOST_TERMINAL',
